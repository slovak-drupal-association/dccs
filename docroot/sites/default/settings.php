...
$settings['hash_salt'] = '046683edbb2789ddd903512aef3303d1d9fd2ac4e0fe4da6f79a38d2c87
29a25';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalcampslovakia_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalcampslovakia_dev_default.inc';
}
// </DDSETTINGS>
