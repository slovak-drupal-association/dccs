 ...
 * @endcode
 */
$settings['hash_salt'] = 'EGdR5UmHhsXMCjAevL4ENz5fAYTO1fYT9T2zrT4zmwOHlSRYuvzqy4P6pYrysoX0QFHWS_395w';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_dccs_2015_dd.inc')) {
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_dccs_2015_dd.inc');
}
//</DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'dccs_2015',
